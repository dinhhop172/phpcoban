...
<html lang="en">
  ...
  <head>
    ...
    <!-- All CSS Plugins -->
    <link rel="stylesheet" type="text/css" href="<?php echo $dir;?>css/plugin.css">
    
    <!-- Main CSS Stylesheet -->
    <link rel="stylesheet" type="text/css" href="<?php echo $dir;?>css/style.css">
  ...
  <body>
           ...
           <div class="col-md-12">
                  ...
                  <a href="" data-toggle="modal" data-target="#reason" title="Why You Are Seeing 404 Page"><i class="icon-question bounce"></i></a>
                            ...
                            <p>The Page You Are Looking For Doesn't Exist.</p>
                             ...
                             <div class="text-center">
                               <a class="button button-style" href="?controller=product&action=list">Back To Home</a>
                            </div>
    ...
    <script type="text/javascript" src="<?php echo __DIR__;?>../js/jquery.min.js"></script>
    <script type="text/javascript" src="<?php echo __DIR__;?>../js/plugin.js"></script>
    
    <!-- Main Javascript File  -->
    <script type="text/javascript" src="<?php echo __DIR__;?>/js/scripts.js"></script>
